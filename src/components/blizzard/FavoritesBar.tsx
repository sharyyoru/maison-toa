...
> = {
  ...
  "/image-library": { icon: "workflows", labelKey: "imageLibrary" },
  "/marketing": { icon: "emailReports", label: "Newsletter & Campaigns" },
  "/marketing/campaigns": { icon: "emailReports", label: "New Campaign" },
...
const ALL_PAGES: Favorite[] = [
  ...
  { href: "/image-library", icon: "workflows" },
  { href: "/marketing/campaigns", icon: "emailReports" },
  { href: "/marketing", icon: "emailReports" },

                      ...
                      >
                        ...
                        <div className="flex-shrink-0 flex items-center gap-0.5">
                          ...
                          {item.source !== "patient-docs" && (getExtension(item.name) === "docx" || getExtension(item.name) === "pdf") && (
                            <Tooltip label={getExtension(item.name) === "pdf" ? "Annotate PDF" : "Edit document"}>
                              <button
                                type="button"
                                onClick={async (e) => {
                                  e.stopPropagation();
                            ...
                            <div className="relative">
                              <Tooltip label="More options">
                                <button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    setMoreMenuOpenPath((current) => (current === item.path ? null : item.path));
                                  }}

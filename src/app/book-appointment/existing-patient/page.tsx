...
export default function ExistingPatientCategoryPage() {
  ...
  const fetchCategories = async () => {
    try {
      ...
      // Filter for existing patient categories that are enabled
      const existingPatientCategories = (data.categories || [])
        .filter((cat: any) => cat.patient_type === "existing" && cat.enabled)
        .sort((a: any, b: any) => a.order_index - b.order_index);
      
      setCategories(existingPatientCategories);
    } catch (error) {

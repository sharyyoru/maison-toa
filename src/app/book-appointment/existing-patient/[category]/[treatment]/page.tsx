...
export default function SelectDoctorPage() {
  ...
  const handleSelectEarliestSlot = (doctorSlug: string, date: string, time: string) => {
    ...
    router.push(`/book-appointment/existing-patient/${categorySlug}/${treatmentId}/${doctorSlug}?date=${date}&time=${time}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 relative">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Back Button */}
        <Link
          href={treatmentId === "none" ? `/book-appointment/existing-patient` : `/book-appointment/existing-patient/${categorySlug}`}

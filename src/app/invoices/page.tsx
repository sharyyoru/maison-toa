...
export default function InvoicesPage() {
  ...
  const isPdfStale = (row: InvoiceRow) => {
    if (!row.pdf_path || !row.pdf_generated_at || !row.updated_at) return false;
                    ...
                    <td className="px-3 py-2 text-center">
                      {row.pdf_path ? (
                        <div className="flex items-center justify-center gap-1">
                          ...
                          {isPdfStale(row) && (
                            <span className="rounded-full bg-amber-100 px-1.5 py-0.5 text-[9px] font-medium text-amber-700" title="Invoice edited after PDF was generated — regenerate to update">
                              stale
                            </span>
                          )}
                        </div>

...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "booking.selectDateDesc": "Please select a date when {doctor} is available at {location}.",
    "booking.date": "Date",
  ...
  fr: {
    ...
    "booking.selectDate": "Sélectionner la date et l'heure",
    "booking.selectDateDesc": "Veuillez sélectionner une date où {doctor} est disponible à {location}.",
    "booking.date": "Date",
